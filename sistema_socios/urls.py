...
from sistemaApp.views import (
    ...
    logout_view,
    panel,
    solicitud_ingreso_publico,
    perfil_socio,
    area_personal,
    socio_pagos,
    socio_cuotas,
    exportar_mis_pagos_excel,
    exportar_mis_pagos_pdf,
    exportar_mis_cuotas_excel,
    exportar_mis_cuotas_pdf,
    socio_credencial,
...
urlpatterns = [
    ...
    path('solicitud/', solicitud_ingreso_publico, name='solicitud_ingreso'),
    ...
    path('mis-pagos/exportar/excel/', exportar_mis_pagos_excel, name='exportar_mis_pagos_excel'),
    path('mis-pagos/exportar/pdf/', exportar_mis_pagos_pdf, name='exportar_mis_pagos_pdf'),
    path('mis-cuotas/', socio_cuotas, name='socio_cuotas'),
    path('mis-cuotas/exportar/excel/', exportar_mis_cuotas_excel, name='exportar_mis_cuotas_excel'),
    path('mis-cuotas/exportar/pdf/', exportar_mis_cuotas_pdf, name='exportar_mis_cuotas_pdf'),
